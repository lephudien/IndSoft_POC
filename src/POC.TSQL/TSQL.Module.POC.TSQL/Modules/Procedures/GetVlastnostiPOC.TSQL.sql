CREATE
PROCEDURE [Module.POC.TSQL].[GetVlastnostiPOC.TSQL]
	--@O_Result [Module.POC.TSQL].[VlastnostiPOC.TSQL] = null,
	@blokObjectId bigint
AS
...
BEGIN
	...
	--declare @O_Result [Module.POC.TSQL].[VlastnostiPOC.TSQL] = null
	...
	select top 0 * into #result from  [Module.POC.TSQL].[VlastnostiPOC.TSQL]
