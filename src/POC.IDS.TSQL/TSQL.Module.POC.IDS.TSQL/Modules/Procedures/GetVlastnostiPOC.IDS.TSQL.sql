CREATE
PROCEDURE [Module.POC.IDS.TSQL].[GetVlastnostiPOC.IDS.TSQL]
	--@O_Result [Module.POC.IDS.TSQL].[VlastnostiPOC.IDS.TSQL] = null,
	@blokObjectId bigint
AS
...
BEGIN
	...
	--declare @O_Result [Module.POC.IDS.TSQL].[VlastnostiPOC.IDS.TSQL] = null
	...
	select top 0 * into #result from  [Module.POC.IDS.TSQL].[VlastnostiPOC.IDS.TSQL]
