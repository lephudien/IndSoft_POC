CREATE
PROCEDURE [Module.POC.Server].[GetVlastnostiPOC.Server]
	--@O_Result [Module.POC.Server].[VlastnostiPOC.Server] = null,
	@blokObjectId bigint
AS
...
BEGIN
	...
	--declare @O_Result [Module.POC.Server].[VlastnostiPOC.Server] = null
	...
	select top 0 * into #result from  [Module.POC.Server].[VlastnostiPOC.Server]
